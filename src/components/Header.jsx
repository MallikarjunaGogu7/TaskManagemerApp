...
return (
    <div className='header-container d-flex justify-content-between align-items-center p-4 border'>
       ...
       <h1 className='header-title '>{isNewFest?"Happy Ugadi 2025🎉🎉":"Advanced happy Ugadi🎉🎉"}</h1>
       <p className='fs-3 '>Make this year <strong className='text-success fs-1'>{currentword}</strong></p>
       </div>
       {/* countdown-timer */}
